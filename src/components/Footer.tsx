    ...
    <footer className="py-10 border-t border-gray-150/40 dark:border-darkBorder/40 relative">
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <button
          ...
          className="p-2.5 rounded-xl bg-purple-50 dark:bg-darkCard text-purple-600 dark:text-purple-400 border border-purple-200/20 hover:bg-purple-100 dark:hover:bg-darkBorder/80 transition-all duration-300 hover:-translate-y-0.5"
